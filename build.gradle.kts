...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::spring-kotlin-cache")
        property("sonar.projectName", "spring-kotlin-cache")
...
publishing {
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("spring-kotlin-cache")
                description.set("Caching library for Kotlin with Spring Boot.")
                ...
                scm {
                    url.set("https://github.com/mbogner/library-spring-kotlin-cache")
                    connection.set("git@github.com:mbogner/library-spring-kotlin-cache.git")
                    developerConnection.set("git@github.com:mbogner/library-spring-kotlin-cache.git")
                }
                developers {
                    developer {
                        id.set("mbo")
